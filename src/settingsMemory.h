...
#define MEMORY_MODULE_NUM_AABBNODES           3
#define MEMORY_MODULE_NUM_PHYSCOLLIDERS       4
#define MEMORY_MODULE_NUM_PHYSRIGIDBODYDEFS   2
#define MEMORY_MODULE_NUM_PHYSRIGIDBODIES     2
#define MEMORY_MODULE_NUM_OBJECTDEFS          3
#define MEMORY_MODULE_NUM_OBJECTS             3
#define MEMORY_MODULE_NUM_RENDERABLEDEFS      3
#define MEMORY_MODULE_NUM_RENDERABLES         3
