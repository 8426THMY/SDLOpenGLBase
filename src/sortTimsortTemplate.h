...
#define timsortFlexibleDefine(name, type)                                                              \
	...
	void timsort##name##Flexible(                                                                      \
		...
		for(;;){                                                                                       \
			if(size < arraySize){                                                                      \
				insertionSort##name##Flexible(subArray, TIMSORT_RUN_SIZE, compare);                    \
			}else{                                                                                     \
				insertionSort##name##Flexible(subArray, TIMSORT_RUN_SIZE + arraySize - size, compare); \
				break;                                                                                 \
			}                                                                                          \
			subArray += TIMSORT_RUN_SIZE;                                                              \
			size += TIMSORT_RUN_SIZE;                                                                  \
